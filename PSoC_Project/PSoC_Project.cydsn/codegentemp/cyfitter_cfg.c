...
#define BS_UDB_0_1_0_CONFIG_VAL ((const uint8 CYFAR *)0x48000470u)
...
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x48000514u)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SC2_SW0, 0x18u);
...
uint8 CYXDATA * const CYCODE AMux_TIA_input__addrTable[3] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE AMux_TIA_input__maskTable[3] = {
	0x10u, 
	0x01u, 
	0x00u, 
};
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
uint8 CYXDATA * const CYCODE AMux_TIA_resistor_bypass__addrTable[2] = {
	(uint8 CYXDATA *)CYREG_DSM0_SW0, (uint8 CYXDATA *)CYREG_PRT1_AG, 
};

/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE AMux_TIA_resistor_bypass__maskTable[2] = {
	0x04u, 0x40u, 
};
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
uint8 CYXDATA * const CYCODE AMux_V_source__addrTable[2] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE AMux_V_source__maskTable[2] = {
	0x20u, 
	0x02u, 
};

/*******************************************************************************
* Function Name: AMux_V_source_Set
********************************************************************************
* Summary:
*  This function is used to set a particular channel as active on the AMux.
*
...
*
*******************************************************************************/
void AMux_V_source_Set(uint8 channel)
{
	if (channel < 2)
	{
		*AMux_V_source__addrTable[channel] |= AMux_V_source__maskTable[channel];
	}
}

/*******************************************************************************
* Function Name: AMux_V_source_Unset
********************************************************************************
* Summary:
*  This function is used to clear a particular channel from being active on the
*  AMux.
...
*
*******************************************************************************/
void AMux_V_source_Unset(uint8 channel)
{
	if (channel < 2)
	{
		*AMux_V_source__addrTable[channel] &= (uint8)~AMux_V_source__maskTable[channel];
	}
}
